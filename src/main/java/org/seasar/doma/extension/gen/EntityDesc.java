...
public class EntityDesc extends ClassDesc {
   ...
   * エンティティプロパティ記述のリスト
   *
   * <p>親エンティティがある場合に、親エンティティのプロパティも対象になります。
   */
   ...
   *
   * <p>親エンティティがある場合に、親エンティティのプロパティは対象外となります。
   *
   * @since 1.7.0
   */
   ...
   *
   * @param originalStatesPropertyName 元のステートを表すプロパティの名前
   */
   ...
   * エンティティプロパティ記述を追加します。
   *
   * @param entityPropertyDesc エンティティプロパティ記述
   */
   ...
   * テーブルの完全修飾名
   *
   * @param qualifiedTableName テーブルの完全修飾名を設定します。
   */
